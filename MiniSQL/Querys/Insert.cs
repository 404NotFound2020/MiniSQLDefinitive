    ...
    public class Insert : DataManipulationQuery
    {
        ...
        protected override void ValidateParameters(ITable table)
        {
            ...
            else
            {
                ...
                {
                    dictionary.Add(columnEnumerator.Current.columnName, valuesEnumerator.Current);
                ...
                if (!table.primaryKey.Evaluate(dictionary)) this.SaveTheError(QuerysStringResultConstants.PrimaryKeyError);
        ...
        {
            return SystemeConstants.InsertPrivilegeName;
        }
    }
}
